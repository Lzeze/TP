...
<div class="main"><!-- MAIN -->
    <div class="container_12">
        <div class="grid_8">
            <div class="container">
                <ul class="portfolio_1_col group"><!-- PORTFOLIO ITEMS -->
                    <li class="item" data-id="id-1" data-type="html">
                        <?php if(is_array($images)): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo ($vo['savepath']); ?>" rel="prettyPhoto[portfolio]">
                               <?php if($key == 0): ?><img src="<?php echo ($vo['savepath']); ?>" alt="<?php echo ($info["title"]); ?>" /><?php endif; ?>
        ...
        <div class="grid_4"><!-- SIDEBAR -->
            <div id="portfolio_single">
                <h3><?php echo (L("T_PRODUCT_ABOUT")); ?></h3>
                <p>
                    <?php echo ($info['summary']); ?>
                </p><br />
                <div class="divider2"></div>
                <h3><?php echo (L("T_PRODUCT_DETAIL")); ?></h3>
                <div class="list-type-3">
                    <ul>
                        <li><?php echo (L("T_NAME")); ?>：<?php echo ($info["title"]); ?></li>
                        <li>
                            <?php echo (L("T_PRICE")); ?>：<?php echo (L("T_F")); echo ($info["price"]); ?>
                        </li>
                        <li>
                            <?php echo (L("T_PSIZE")); ?>：<?php echo ($info["psize"]); ?>
                        </li>
                        <li>
                            <?php echo (L("T_CAT")); ?>：<?php echo ($info["cname"]); ?>
                        </li>
                    </ul>
                </div>
                <div class="divider3"></div>
                <!-- large grey button -->
                <a class="button large black" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($site["qq"]); ?>&site=qq&menu=yes"><?php echo (L("T_COUNSEL")); ?></a>
                <a class="button large black" href="#content"><?php echo (L("T_PRODUCT_CONTENT")); ?></a>
                <!-- large grey button -->
