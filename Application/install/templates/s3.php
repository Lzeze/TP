                    ...
                    <div class="server">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sitename" value="科技有限公司" class="input"></td>
                            ...
                            <tr>
                                <td class="tar">关键词：</td>
                                <td><input type="text" name="sitekeywords" value="我的关键词" class="input" autoComplete="off"></td>
                                <td><div id="J_install_tip_sitekeywords"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">描述：</td>
                                <td><textarea class="input" name="siteinfo">这里写描述</textarea></td>
